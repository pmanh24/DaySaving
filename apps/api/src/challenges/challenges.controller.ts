...
export class ChallengesController {
  ...
  @Post(":challengeId/checkins/manual") manualCheckIn(@CurrentUser() user: PublicUser, @Param("challengeId") challengeId: string, @Body() dto: CheckinDto) { return { success: true, data: this.challenges.checkIn(user.id, challengeId, dto.number, dto.idempotencyKey) }; }
