        ...
        <div className="choice-list">
          ...
          >
            ...
            <span className="choice-copy">
              <strong>Tự tiết kiệm tiền mặt</strong>
              <small>
                Bạn tự bỏ tiền vào phong bì hoặc nơi riêng của mình, rồi tick ô.
              </small>
            </span>
          ...
          >
            ...
            <span className="choice-copy">
              <strong>Gửi vào quỹ qua QR</strong>
              <small>Hệ thống tạo QR để bạn chuyển đúng số tiền.</small>
            </span>
            {loading ? <LoaderCircle size={18} className="spin" /> : null}
          </button>
        </div>
        <button
          className="button secondary sheet-cancel"
          onClick={onClose}
          disabled={loading}
        >
          Để sau
